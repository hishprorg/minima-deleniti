# @hishprorg/minima-deleniti

[![License](https://img.shields.io/npm/l/@hishprorg/minima-deleniti.svg)](LICENSE)
[![Version](https://img.shields.io/npm/v/@hishprorg/minima-deleniti.svg)](https://www.npmjs.com/package/@hishprorg/minima-deleniti)
[![Total npm downloads](https://img.shields.io/npm/dt/@hishprorg/minima-deleniti.svg)](https://www.npmjs.com/package/@hishprorg/minima-deleniti)
[![Commits](https://img.shields.io/github/commit-activity/y/dequelabs/@hishprorg/minima-deleniti.svg)](https://github.com/hishprorg/minima-deleniti/commits/develop)
[![GitHub contributors](https://img.shields.io/github/contributors/dequelabs/@hishprorg/minima-deleniti.svg)](https://github.com/hishprorg/minima-deleniti/graphs/contributors)
[![Join our Slack chat](https://img.shields.io/badge/slack-chat-purple.svg?logo=slack)](https://accessibility.deque.com/axe-community)
[![Package Quality](https://npm.packagequality.com/shield/@hishprorg/minima-deleniti.svg)](https://packagequality.com/#?package=@hishprorg/minima-deleniti)
...
With @hishprorg/minima-deleniti, you can find **on average 57% of WCAG issues automatically**. Additionally, @hishprorg/minima-deleniti will return elements as "incomplete" where @hishprorg/minima-deleniti could not be certain, and manual review is needed.
...
```console
npm install @hishprorg/minima-deleniti --save-dev
```

Now include the javascript file in each of your iframes in your fixtures or test systems:

```html
<script src="node_modules/@hishprorg/minima-deleniti/axe.min.js"></script>
```
...
The [@hishprorg/minima-deleniti API](doc/API.md) fully supports the following browsers:
...
The [@hishprorg/minima-deleniti API](doc/API.md) package consists of:
...
To create a new translation for axe, start by running `grunt translate --lang=<langcode>`. This will create a json file in the `./locales` directory, with the default English text in it for you to translate. Alternatively, you could copy `./locales/_template.json`. We welcome any localization for @hishprorg/minima-deleniti. For details on how to contribute, see the Contributing section below. For details on the message syntax, see [Check Message Template](/doc/check-message-template.md).
...
- See [release and support](doc/release-and-support.md) for details on the frequency of releases, long-term support and recommendations on upgrading @hishprorg/minima-deleniti.
...
Refer [@hishprorg/minima-deleniti ARIA support](./doc/aria-supported.md) for a complete list of ARIA supported roles and attributes by axe.
...
## Projects using @hishprorg/minima-deleniti

[List of projects using @hishprorg/minima-deleniti](doc/projects.md)
